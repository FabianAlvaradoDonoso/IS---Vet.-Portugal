<?php
    ...
    while ($row=mysqli_fetch_array($res)){
        ...
        $tmp.= "<tr class='".$class."'>
                    ...
                    <td>" . $row["STOCK_ACT"] . "</td>
                    <td>" . $row["BODEGA"] . "</td>
                    <td align='center'><button type='button' class='btn btn-outline-success btn-sm' onclick='mostrarModalModificar(\"$codigo\",\"$categoria\",\"$proveedor\",\"$nombre\",\"$precioVenta\",\"$precioNeto\",\"$fechaVenc\",\"$fechaAdq\",\"$stockMin\",\"$stockAct\",\"$bodega\")'><span class='fas fa-edit'</span></button>
