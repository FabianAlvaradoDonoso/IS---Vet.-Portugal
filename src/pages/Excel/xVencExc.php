...
$titulo = "Por Vencer - " . date("d") . "/" . date("m") . "/" . date("Y");
...
require_once '../../../Classes/PHPExcel.php';
    ...
    $sql_total="SELECT
            ...
            WHERE 
                p.FECHA_VENC BETWEEN curdate() and ADDDATE(CURDATE(), INTERVAL 2 MONTH)  and p.STOCK_ACT > 0";
...
header('Content-Disposition: attachment;filename="Por Vencer.xls"');
